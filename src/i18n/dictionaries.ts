...
const en = {
  ...
  game: {
    ...
    room: {
      ...
      accountTokenPlaceholder: "Original token (for token login or claiming passwordless account)",
      blackSeat: "Black",
      copyAccountToken: "Copy token",
      loginAccount: "Log in",
      loginTab: "Log in",
      guestSessionError: "Guest session expired. Starting a new session...",
      ...
      createUnlistedRoomHint: "Allocates a random room code and a share link.",
...
const zh = {
  ...
  game: {
    ...
    room: {
      ...
      accountTokenPlaceholder: "原设备令牌 (用于令牌登录或认领无密码账号)",
      blackSeat: "黑棋",
      copyAccountToken: "复制令牌",
      loginAccount: "登录",
      loginTab: "登录",
      guestSessionError: "访客会话已失效，正在启动新会话...",
      ...
      createUnlistedRoomHint: "系统将自动分配随机房间码与邀请链接。",
      disconnected: "已断开",
      downloadSgf: "下载 SGF",
      editIdentity: "编辑身份",
      findMatch: "随机匹配",
...
const fr = {
  ...
  game: {
    ...
    room: {
      ...
      accountTokenPlaceholder: "Jeton d'origine (connexion par jeton ou réclamation sans mot de passe)",
      blackSeat: "Noirs",
      copyAccountToken: "Copier le jeton",
      loginAccount: "Se connecter",
      loginTab: "Connexion",
      guestSessionError: "Session invité expirée. Démarrage d'une nouvelle session...",
      ...
      createUnlistedRoomHint: "Attribue un code aléatoire et un lien d'invitation.",
...
const es = {
  ...
  game: {
    ...
    room: {
      ...
      accountTokenPlaceholder: "Token original (para iniciar con token o reclamar cuenta sin contraseña)",
      blackSeat: "Negras",
      copyAccountToken: "Copiar token",
      loginAccount: "Iniciar sesión",
      loginTab: "Iniciar sesión",
      guestSessionError: "Sesión de invitado caducada. Iniciando nueva sesión...",
      ...
      createUnlistedRoomHint: "Asigna un código aleatorio y un enlace de invitación.",
...
const ru = {
  ...
  game: {
    ...
    room: {
      ...
      accountTokenPlaceholder: "Исходный токен (для входа по токену или привязки без пароля)",
      blackSeat: "Черные",
      copyAccountToken: "Копировать токен",
      loginAccount: "Войти",
      loginTab: "Вход",
      guestSessionError: "Сессия гостя истекла. Запуск новой сессии...",
      ...
      createUnlistedRoomHint: "Генерирует случайный код и ссылку-приглашение.",
...
const ar = {
  ...
  game: {
    ...
    room: {
      ...
      accountTokenPlaceholder: "الرمز الأصلي (لتسجيل الدخول بالرمز أو المطالبة بحساب بدون كلمة مرور)",
      blackSeat: "الأسود",
      copyAccountToken: "نسخ الرمز",
      loginAccount: "تسجيل الدخول",
      loginTab: "دخول",
      guestSessionError: "انتهت جلسة الضيف. جارٍ بدء جلسة جديدة...",
      ...
      createUnlistedRoomHint: "يخصص رمز غرفة عشوائيًا ورابط دعوة.",
