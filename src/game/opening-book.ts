// Generated from data/openings/generated/standard-26-insane-8ply-1s.sgf.
// Keep the SGF as the source of truth and regenerate this file after replacing that asset.

type OpeningBookDifficulty = "normal" | "hard" | "expert" | "insane";

export type RuntimeOpeningBookLine = {
  id: string;
  name: string;
  minDifficulty: OpeningBookDifficulty;
  weight: number;
  source: string;
  moves: Array<{ row: number; col: number }>;
};

export const GENERATED_OPENING_BOOK_LINES: RuntimeOpeningBookLine[] = [
  {
    "id": "generated-d1-v1",
