...
- **最新阶段交付提交**：`52c17a6 docs(plan): game persistence, locale switching fix, and appearance preservation design`（本字段记录本字段所在提交的直接前驱阶段交付；本提交为「对局持久化/语言平滑切换方案」Round 1 审查缺陷闭环交付，其 SHA 由下一次交付回填）
- **环境基准**：
  - Node.js v24.x
  - npm 11.x
  - TypeScript 5.8.x
